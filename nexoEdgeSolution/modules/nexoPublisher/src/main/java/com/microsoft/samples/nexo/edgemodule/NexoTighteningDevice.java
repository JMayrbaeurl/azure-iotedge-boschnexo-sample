 ...
 */
public class NexoTighteningDevice implements TwinPropertyCallBack {
    ...
    public void TwinPropertyCallBack(Property property, Object context) {
        ...
        logger.debug("Twin propertey callback for " + (property.getIsReported()?"reported": "desired") +
			" property " + property.getKey() + " to " + property.getValue() +
			", Properties version:" + property.getVersion());

		if (property.getIsReported()) {
			this.setReportedProp(property);
		}
    }
